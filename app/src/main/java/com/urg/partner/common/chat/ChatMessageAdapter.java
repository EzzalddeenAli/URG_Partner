package com.urg.partner.common.chat;
...
import static com.urg.partner.base.BaseActivity.getDisplayableTime;
...
public class ChatMessageAdapter extends ArrayAdapter<Chat> {
    ...
    ChatMessageAdapter(AppCompatActivity context, List<Chat> data) {
