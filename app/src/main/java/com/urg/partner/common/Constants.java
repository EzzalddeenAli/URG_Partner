...
public class Constants {
    ...
    public static final String userAppPackageName = "com.urg.user";
    public static final String DEFAULT_COUNTRY_DIAL_CODE = "+593";
    public static final String DEFAULT_COUNTRY_CODE = "EC";
