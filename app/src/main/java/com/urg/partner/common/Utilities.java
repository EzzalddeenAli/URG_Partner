package com.urg.partner.common;
...
import com.urg.partner.ui.activity.welcome.WelcomeActivity;
...
public class Utilities {
    ...
    public static void LogoutApp(AppCompatActivity thisActivity, String logout_text) {

        logout_text = "Se desconectó con éxito!";
    ...
    public static void LogoutApp(AppCompatActivity thisActivity) {
