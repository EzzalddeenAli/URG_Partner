...
import com.urg.partner.data.network.model.ServiceType;
import com.urg.partner.data.network.model.SettingsResponse;
import com.urg.partner.data.network.model.UserResponse;
import com.urg.partner.ui.activity.change_password.ChangePasswordActivtiy;
...
serviceId=user.getService().getServiceType().getId();
    ...
    public void onVerifyEmailError(Throwable e) {
        isEmailAvailable = true;Toasty.error(this, getString(R.string.email_already_exist), Toast.LENGTH_SHORT).show();
