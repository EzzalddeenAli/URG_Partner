...
import com.urg.partner.BuildConfig;
import com.urg.partner.MvpApplication;
import com.urg.partner.R;
import com.urg.partner.base.BaseActivity;
import com.urg.partner.common.ChatHeadService;
import com.urg.partner.common.Constants;
import com.urg.partner.common.GPSTracker;
import com.urg.partner.common.LocaleHelper;
import com.urg.partner.common.PolyUtil;
import com.urg.partner.common.SharedHelper;
import com.urg.partner.common.Utilities;
import com.urg.partner.common.chat.ChatActivity;
import com.urg.partner.common.fcm.MyFireBaseMessagingService;
import com.urg.partner.common.swipe_button.SwipeButton;
import com.urg.partner.data.network.model.LatLngFireBaseDB;
...
import com.urg.partner.ui.activity.add_card.AddCardActivity;
import com.urg.partner.ui.activity.card.CardActivity;
import com.urg.partner.ui.activity.document.DocumentActivity;
import com.urg.partner.ui.activity.earnings.EarningsActivity;
import com.urg.partner.ui.activity.help.HelpActivity;
import com.urg.partner.ui.activity.instant_ride.InstantRideActivity;
import com.urg.partner.ui.activity.invite.InviteActivity;
import com.urg.partner.ui.activity.invite_friend.InviteFriendActivity;
import com.urg.partner.ui.activity.notification_manager.NotificationManagerActivity;
import com.urg.partner.ui.activity.profile.ProfileActivity;
import com.urg.partner.ui.activity.setting.SettingsActivity;
import com.urg.partner.ui.activity.summary.SummaryActivity;
import com.urg.partner.ui.activity.wallet.WalletActivity;
import com.urg.partner.ui.activity.your_trips.YourTripActivity;
import com.urg.partner.ui.bottomsheetdialog.invoice_flow.InvoiceDialogFragment;
import com.urg.partner.ui.bottomsheetdialog.rating.RatingDialogFragment;
import com.urg.partner.ui.fragment.incoming_request.IncomingRequestFragment;
import com.urg.partner.ui.fragment.offline.OfflineFragment;
import com.urg.partner.ui.fragment.status_flow.StatusFlowFragment;
...
import static com.urg.partner.MvpApplication.DATUM;
...
import static com.urg.partner.MvpApplication.canGoToChatScreen;
import static com.urg.partner.MvpApplication.isChatScreenOpen;
...
public class MainActivity extends BaseActivity implements
    ...
    private static void startFloatingViewService(AppCompatActivity activity) {
        ...
        try {
            ...
            r = () -> {
                if (mLastKnownLocation != null) {
                    ...
                    params.put("longitude", mLastKnownLocation.getLongitude());
                    presenter.getTrip(params);
                } else if (DATUM.getStatus().equals(Constants.checkStatus.STARTED) || DATUM.getStatus().equals(Constants.checkStatus.ARRIVED)
                        || DATUM.getStatus().equals(Constants.checkStatus.PICKEDUP)) if (canMapAnimate % 3 == 0) {
        ...
        mProviderLocation.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                try {
                    ...
                    if (lng > 0 && lat > 0)
                        if (Constants.checkStatus.STARTED.equalsIgnoreCase(DATUM.getStatus()) ||
