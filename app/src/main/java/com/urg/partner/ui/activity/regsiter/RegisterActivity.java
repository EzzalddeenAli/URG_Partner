package com.urg.partner.ui.activity.regsiter;
...
public class RegisterActivity extends BaseActivity implements RegisterIView {
    ...
    private void getUserCountryInfo() {
        ...
        countryDialCode = "+593";//country.getDialCode();
        countryCode = "EC";//country.getCode();
    }
    ...
    private void register(String countryCode, String phoneNumber) {
        ...
        intent.putExtra("service_type", lstServiceTypes.get(selected_pos).getId() + "");
